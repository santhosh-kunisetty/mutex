...
extern int sys_kthread_fetchretval(void);
extern int sys_kthread_saveretval(void);
...
[SYS_kthread_saveretval] sys_kthread_saveretval,
[SYS_kthread_fetchretval] sys_kthread_fetchretval,
};
